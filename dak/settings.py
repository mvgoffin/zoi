"""
Django settings for dak project.
...
ALLOWED_HOSTS = ['localhost', '198.199.123.95', 'www.dakdemo.com', 'dakdemo.com']
...
WSGI_APPLICATION = 'dak.wsgi.application'
