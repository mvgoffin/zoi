...
urlpatterns = [
    ...
    path('checkout_calm_bottle/', user_views.checkout_calm_bottle, name='checkout_calm_bottle'),
    path('checkout_skincare_bottle/', user_views.checkout_skincare_bottle, name='checkout_skincare_bottle'),
