"""
Django settings for django-contactform project.
...
ALLOWED_HOSTS = ['localhost', '198.211.109.207']
...
ROOT_URLCONF = 'django-contactform.urls'
...
WSGI_APPLICATION = 'django-contactform.wsgi.application'
